...
# Estilo con fondo azul oscuro y personalización del título
st.markdown("""
    <style>
    .stApp {
    ...
    <div class="header">
        <img src="https://i.imgur.com/VXZhKFU.png" alt="logo">
        <div class="header-title">Calculadora <span>La Solución</span></div>
    </div>
